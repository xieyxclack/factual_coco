...
class BARTModel(TransformerModel):
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        def add_emb(key):
            if key in state_dict:
                added = state_dict[key][-2:-1,:]
                state_dict[key] = torch.cat([state_dict[key], added], axis=0)
        ...
        if (
            ...
            add_emb("encoder.embed_tokens.weight")
            add_emb("decoder.embed_tokens.weight")
            add_emb("encoder.output_projection.weight")
            add_emb("decoder.output_projection.weight")
